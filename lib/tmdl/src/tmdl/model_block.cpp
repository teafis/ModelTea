...
export module tmdl:model_block;
...
std::string tmdl::ModelBlock::get_description() const { return model->get_description(); }

size_t tmdl::ModelBlock::get_num_outputs() const { return model->get_num_outputs(); }

size_t tmdl::ModelBlock::get_num_inputs() const { return model->get_num_inputs(); }
...
struct CompiledModelBlock : public tmdl::CompiledBlockInterface {
    CompiledModelBlock(const size_t id, std::shared_ptr<const tmdl::Model> model, const tmdl::BlockInterface::ModelInfo& s)
    ...
    std::unique_ptr<tmdl::codegen::CodeComponent> get_codegen_self() const override { return _model->get_codegen_component(_state); }
...
std::shared_ptr<tmdl::Model> tmdl::ModelBlock::get_model() { return model; }

std::shared_ptr<const tmdl::Model> tmdl::ModelBlock::get_model() const { return model; }

...
std::string tmdl::blocks::TrigSin::get_description() const { return "computes the sine of the input parameter"; }
...
std::string tmdl::blocks::TrigCos::get_description() const { return "computes the cosine of the input parameter"; }
...
std::string tmdl::blocks::TrigTan::get_description() const { return "computes the tangent of the input parameter"; }

std::unique_ptr<tmdl::CompiledBlockInterface> tmdl::blocks::TrigTan::get_compiled(const ModelInfo&) const {
...
std::string tmdl::blocks::TrigASin::get_description() const { return "computes the arcsine of the input parameter"; }

std::unique_ptr<tmdl::CompiledBlockInterface> tmdl::blocks::TrigASin::get_compiled(const ModelInfo&) const {
...
std::string tmdl::blocks::TrigACos::get_description() const { return "computes the arccosine of the input parameter"; }

std::unique_ptr<tmdl::CompiledBlockInterface> tmdl::blocks::TrigACos::get_compiled(const ModelInfo&) const {
...
std::string tmdl::blocks::TrigATan::get_description() const { return "computes the arctangent of the input parameter"; }

std::unique_ptr<tmdl::CompiledBlockInterface> tmdl::blocks::TrigATan::get_compiled(const ModelInfo&) const {

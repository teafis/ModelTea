...
void PlotVariableSelectionModel::addItem(const ItemSelector& item) { _items.push_back(item); }

const QVector<ItemSelector>& PlotVariableSelectionModel::items() const { return _items; }
